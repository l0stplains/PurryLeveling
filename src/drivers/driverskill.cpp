...
void useSkill(Skill* rootSkill)
{
    ...
    else
    {
        ...
        {
            cout << "- " << effect->GetName() << ": " << effect->GetDescription()
...
int main()
{
    ...
    // Test semua kemungkinan yang bisa kaya print semua effect yang ada di active skill sekarang
    // dan testing learn funciton Skill Tree
