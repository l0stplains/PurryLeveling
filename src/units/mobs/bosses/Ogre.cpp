...
Ogre::Ogre(const std::string&  name,
           const sf::Vector2f& position,
           NavigationGrid&     navGrid,
           const GameContext&  gameContext)
    : Unit(name),
      m_pulverize(true, true),
      Mob(name),
      ...
      AnimatedUnit(name, position, navGrid, false, gameContext)
{
    ...
    std::unordered_map<UnitAnimationType, std::string> ogreTexturePaths = {
        {UnitAnimationType::IDLE, "mob_yeti_idle"},
        {UnitAnimationType::WALK, "mob_yeti_walk"},
        {UnitAnimationType::ATTACK, "mob_yeti_attack"},
        {UnitAnimationType::JUMP, "mob_yeti_jump"},
        {UnitAnimationType::DAMAGE, "mob_yeti_dmg"},
        {UnitAnimationType::DIE, "mob_yeti_die"}

    };
    std::unordered_map<UnitAnimationType, std::string> ogreShadowTexturePaths = {
        {UnitAnimationType::IDLE, "mob_yeti_idle_shadow"},
        {UnitAnimationType::WALK, "mob_yeti_walk_shadow"},
        {UnitAnimationType::ATTACK, "mob_yeti_attack_shadow"},
        {UnitAnimationType::JUMP, "mob_yeti_jump_shadow"},
        {UnitAnimationType::DAMAGE, "mob_yeti_dmg_shadow"},
        {UnitAnimationType::DIE, "mob_yeti_die_shadow"}

    };
    // Example frame counts (adjust these!)
    std::unordered_map<UnitAnimationType, int> ogreFramesPerAnim = {{UnitAnimationType::IDLE, 16},
    ...
    std::unordered_map<UnitAnimationType, float> ogreDurationPerAnim = {
    ...
    std::unordered_map<UnitAnimationType, bool> ogreLoopingAnims = {
    ...
    std::unordered_map<UnitAnimationType, bool> ogreDirectionalAnims = {
        {UnitAnimationType::IDLE, true},
        {UnitAnimationType::WALK, true},
    ...
    std::unordered_map<UnitAnimationType, int> ogreDefaultRows = {{UnitAnimationType::DIE, 0}};

    LoadAnimations(ogreTexturePaths,
                   ogreFrameSize,
                   ogreFramesPerAnim,
                   ogreDurationPerAnim,
                   ogreLoopingAnims,
                   ogreDirectionalAnims,
                   ogreDefaultRows,
                   ogreShadowTexturePaths);
}

void Ogre::Attack(Unit& target, ActionCompletionCallback callback, ActionCompletionCallback onDeath)
{
...
void Ogre::PerformAttack(AnimatedUnit&            target,
...
// void Ogre::RenderUI(sf::RenderWindow& window) {
