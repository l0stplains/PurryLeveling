      ...
      AnimatedUnit(name, position, navGrid, false, gameContext)
{
    ...
    std::unordered_map<UnitAnimationType, std::string> lichTexturePaths = {
        {UnitAnimationType::IDLE, "mob_troll_idle"},
        {UnitAnimationType::WALK, "mob_troll_walk"},
        {UnitAnimationType::ATTACK, "mob_troll_attack"},
        {UnitAnimationType::JUMP, "mob_troll_jump"},
        {UnitAnimationType::DAMAGE, "mob_troll_dmg"},
        {UnitAnimationType::DIE, "mob_troll_die"}

    };
    std::unordered_map<UnitAnimationType, std::string> lichShadowTexturePaths = {
        {UnitAnimationType::IDLE, "mob_troll_idle_shadow"},
        {UnitAnimationType::WALK, "mob_troll_walk_shadow"},
        {UnitAnimationType::ATTACK, "mob_troll_attack_shadow"},
        {UnitAnimationType::JUMP, "mob_troll_jump_shadow"},
        {UnitAnimationType::DAMAGE, "mob_troll_dmg_shadow"},
        {UnitAnimationType::DIE, "mob_troll_die_shadow"}

    };
    // Example frame counts (adjust these!)
    std::unordered_map<UnitAnimationType, int> lichFramesPerAnim = {{UnitAnimationType::IDLE, 16},
    ...
    std::unordered_map<UnitAnimationType, float> lichDurationPerAnim = {
    ...
    std::unordered_map<UnitAnimationType, bool> lichLoopingAnims = {
    ...
    std::unordered_map<UnitAnimationType, bool> lichDirectionalAnims = {
        {UnitAnimationType::IDLE, true},
        {UnitAnimationType::WALK, true},
    ...
    std::unordered_map<UnitAnimationType, int> lichDefaultRows = {{UnitAnimationType::DIE, 0}};

    LoadAnimations(lichTexturePaths,
                   lichFrameSize,
                   lichFramesPerAnim,
                   lichDurationPerAnim,
                   lichLoopingAnims,
                   lichDirectionalAnims,
                   lichDefaultRows,
                   lichShadowTexturePaths);
}

void Lich::Attack(Unit& target, ActionCompletionCallback callback, ActionCompletionCallback onDeath)
{
...
void Lich::PerformAttack(AnimatedUnit&            target,
...
bool Lich::UseSkill(Unit& target, ActionCompletionCallback callback, ActionCompletionCallback onDeath)
{
...
// void Lich::RenderUI(sf::RenderWindow& window) {
