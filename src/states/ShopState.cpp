...
ShopState::ShopState(GameContext& context)
    : State(context),
      ...
      m_backgroundTexture(GetContext().GetResourceManager()->GetTexture("shop_background")),
...
State::StateChange ShopState::ProcessEvent(const sf::Event& event)
{
...
State::StateChange ShopState::Update(const sf::Time& dt)
{
