...
/*
    ...
    2. to get multiple random numbers, you can use generatePercentageVector() or generateRandomVector()
    example:
    RNG rng(69420);
    vector<double> num = rng.generatePercentageVector(10); 10 is the number of random numbers
